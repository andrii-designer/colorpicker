...
export default function ColorScraper() {
  ...
  const scrapeColorValues = async (colors=> {
  ...
  const formatDatabaseEntries = (colors)=> {
            ...
            <div className="flex space-x-4">
              ...
              <label className="flex items-center">
                <input
                  ...
                  className="mr-2"
                />
                With Color Values (Slow, Demo Limited to 10 Colors)</span>
              </label>
            </div>
            <p className="text-xs text-gray-500 mt-1">
              Note it&apos;s better to use a server-side script.
            </p>
          </div>
        ...
        {isLoading && scrapingMethod === 'with-values' && (
          ...
          <div className="mb-4">
            ...
            <p className="mb-2 text-sm text-gray-600">
              Copy and paste this into your color database file </p>
