      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3">
            {/* Color Palette Display with ColorDisplay Component */}
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <div className="mt-4 bg-gray-50 p-4 rounded-md">
                    ...
                    <ul className="text-sm text-gray-600 space-y-2">
                      ...
                      <li>• Try uploading different types of images to see how colors are extracted</li>
                      <li>• Images with distinct color regions generally provide more diverse palettes</li>
                      <li>• Drag and drop colors to reorder your palette</li>
                      <li>• Use the edit tool on each color to fine-tune your palette</li>
                    </ul>
                  </div>
                </div>
              </div>
